...
public class EmailService {
    ...
    public void sendMatchNotification(String ownerEmail, String finderPhone) {
        NotificationRequest request = new NotificationRequest(
                ownerEmail,
                "¡Posible coincidencia encontrada! - Sanos y Salvos",
                "Hemos encontrado una posible coincidencia para tu mascota perdida. " +
                "Contacta al finder al teléfono: " + finderPhone
        );
        sendEmail(request);
    }
